...
{
    [TestClass]
    public class ComparandTest : ParserResultTest<Comparand>
    {
        protected override Parser<Comparand> MyParser
        {
            get 
            {
                return SQLParserComponents.P_Comparand; 
            }
        }
    ...
    [TestClass]
    public class ComparisonTest : ParserResultTest<Expression>
    {
        protected override Parser<Expression> MyParser
        {
            get
            {
                return SQLParserComponents.P_CompareExpression;
            }
        }
