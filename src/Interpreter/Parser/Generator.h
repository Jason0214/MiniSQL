...
namespace Generator{
    ...
    public:
        ...
        virtual ParserSymbol::SLRstate 
                Accept(TokenStream & token_stream, std::stack<ASTreeNode*> & s) = 0;
    };


    class wait_select:public ASTgenerator{
    public:
        ParserSymbol::SLRstate Accept(TokenStream & token_stream, std::stack<ASTreeNode*> & s);
